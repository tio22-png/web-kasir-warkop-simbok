          ...
          <div className="space-y-6">
            <div className="dashboard-card">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  {cart.map(item => (
                    <div key={item.id} className="flex items-center space-x-4 py-4 border-b border-primary/10">
                      <img
                        src={item.image}
                        alt={item.name}
                      ...
                      <div className="flex items-center space-x-4">
                        <input
                          ...
                          className="w-20 px-3 py-2 bg-background text-text border border-primary/30 rounded-lg focus:ring-2 focus:ring-primary/30 focus:border-primary hover:border-primary/50 transition duration-200"
                        />
                        <button
              ...
              <div className="flex items-center space-x-2 sm:space-x-4">
                ...
                {isSidebarOpen && (
                  <div className="flex items-center">
                    ...
                    {cart.length > 0 && (
                      <span className="ml-1 sm:ml-2 bg-accent text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs">
                        {cart.length}
                      </span>
                    )}
                  </div>
