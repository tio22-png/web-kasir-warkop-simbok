              ...
              <div className="p-3">
                ...
                <div className="flex gap-2 mt-3">
                  <button
                    ...
                    className="bg-blue-500 text-white rounded px-3 py-1.5 text-sm hover:bg-blue-600 flex-1 transition-colors"
                  >
                    Edit
                  </button>
                  <button
                    onClick={() => handleDelete(product.id)}
                    className="bg-red-500 text-white rounded px-3 py-1.5 text-sm hover:bg-red-600 flex-1 transition-colors"
                  >
                    Hapus
                  </button>
                </div>
