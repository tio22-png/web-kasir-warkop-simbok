              ...
              <div className="mt-3 sm:mt-4 flex flex-wrap gap-2 sm:space-x-2">
                {payment.payment_status !== 'paid' && (
                  <button
                    ...
                    className="px-3 sm:px-4 py-1.5 sm:py-2 bg-primary text-white text-xs sm:text-sm rounded-lg hover:bg-primary-dark transition-colors shadow-sm flex-1 sm:flex-none"
                  >
                    Konfirmasi Lunas
                  </button>
                )}
